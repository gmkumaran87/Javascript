...
// Make a function that creates a range from x to y with Array.from() with Step count;
...
const myRange = range(3, 27);

// Check if the last array you created is really an array with Array.isArray();
console.log(Array.isArray(myRange), myRange);
